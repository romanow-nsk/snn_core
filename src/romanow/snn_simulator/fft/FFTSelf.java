...
public class FFTSelf { 
    ...
    */
     ...
     */
    public static float[] fftDirect(float[] inputReal){
        return fft(inputReal,null,true);
        }
    public static float[] fft(float[] inputReal, float[] inputImag,
	    boolean DIRECT) {
    ...
    for (int i = 0; i < newArray.length; i++) {
        newArray[i] = (float)(Math.sqrt(xReal[i]*xReal[i]+xImag[i]*xImag[i])*radice);
        }
	return newArray;
    }
